...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        $(function() {
            element.typed({
                strings: ["I'm Developer.", "I am Creative.", "I am Responsable.", "I am Hardworker.", "I'm a Woman.", "I'm Friendly.", "I am Respectful.", "I am a Dedicated person.", "I am Passionate.", "I love what I do."],
                typeSpeed: 100,
                loop: true,
            });
        });
